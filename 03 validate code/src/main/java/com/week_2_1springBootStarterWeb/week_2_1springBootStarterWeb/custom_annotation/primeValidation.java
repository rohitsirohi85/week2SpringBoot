...
@Constraint(validatedBy = {primeValidator.class}) //means connect this validation annotation with employeeRolevalidator.class so it can implement those logic and fields 

/* structure of validation annotation */
public @interface primeValidation {
    String message() default "number only in prime";  //this is the default msg
